...
const Homeschool = () => {
  return (
    <PageLayout>
      {/* Hero */}
      <section className="py-20 bg-fun/10">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <span className="text-fun font-bold text-sm uppercase tracking-wider">Homeschool Programs</span>
            <h1 className="font-display text-4xl md:text-5xl font-bold text-foreground mt-3 mb-6">
              Music Education for Homeschool Families
            </h1>
            ...
            <Link to="/contact">
              <Button size="xl">Inquire About Programs</Button>
            </Link>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { icon: Users, label: "Peer Interaction", bg: "bg-accent/10", color: "text-accent" },
                { icon: Music, label: "Real Skills", bg: "bg-fun/10", color: "text-fun" },
                { icon: Lightbulb, label: "Creative Growth", bg: "bg-highlight/20", color: "text-highlight-foreground" },
              ].map((item) => (
