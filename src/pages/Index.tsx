    ...
    <PageLayout>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-background/30 backdrop-blur-sm" style={{ maskImage: 'radial-gradient(ellipse at center, black 0%, black 50%, transparent 85%)', WebkitMaskImage: 'radial-gradient(ellipse at center, black 0%, black 50%, transparent 85%)' }} />
        </div>
        ...
        <div className="relative w-full flex items-center justify-center min-h-[90vh] px-4">
          <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] lg:grid-cols-[400px_1fr] items-center max-w-5xl w-full">
            {/* Dragon - background on mobile, side column on desktop */}
            <div className="hidden md:flex md:h-[70vh] items-center justify-center rounded-l-3xl">
              <img
                src={flyerDragon}
            ...
            <div className="relative flex items-center justify-center pb-10 md:py-10">
              <div className="text-center max-w-2xl py-10 px-6 md:px-8" style={{ textShadow: '0 0 12px hsl(40 30% 96%), 0 0 24px hsl(40 30% 96%), 0 0 40px hsl(40 30% 96% / 0.7)' }}>
                <h1 className="font-display text-5xl md:text-6xl font-bold text-primary leading-tight mb-3 animate-fade-up lg:text-6xl">Dragon Scale Music Studio (HMR Check)</h1>
