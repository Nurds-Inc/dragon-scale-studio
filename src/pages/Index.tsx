        ...
        <div className="relative w-full flex items-center justify-center min-h-[90vh] px-4">
          <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] lg:grid-cols-[400px_1fr] items-center max-w-5xl w-full">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none md:hidden">
              <img src={flyerDragon} alt="" className="h-[60%] w-auto object-contain opacity-50" />
            </div>
            {/* Content column */}
            <div className="relative flex items-center justify-center pb-10 md:py-10">
              <div className="text-center max-w-2xl py-10 px-6 md:px-8 md:bg-transparent md:backdrop-blur-none md:shadow-none bg-background/60 backdrop-blur-sm rounded-3xl shadow-medium">
