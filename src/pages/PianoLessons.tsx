      ...
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link to="/contact">
              <Button size="xl">Contact for Lesson Availability</Button>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="text-accent font-bold text-sm uppercase tracking-wider">What Students Learn</span>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { icon: BookOpen, label: "Music Theory", bg: "bg-accent/10", color: "text-accent" },
                { icon: Smile, label: "Fun Learning", bg: "bg-highlight/20", color: "text-highlight-foreground" },
