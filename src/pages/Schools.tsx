      ...
      <section className="py-20 bg-primary/5">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <span className="text-primary font-bold text-sm uppercase tracking-wider">For Schools & Administrators</span>
            ...
            <Link to="/contact">
              <Button size="xl">Bring a Music Club to Your School</Button>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="text-accent font-bold text-sm uppercase tracking-wider">What We Provide</span>
